      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/hhhh_7l/59",
                   'caption'=>'𝙏𝙝𝙞𝙨 𝘽𝙤𝙩 𝙋𝙧𝙤𝙜𝙧𝙖𝙢𝙚𝙙 𝘽𝙮 : @jfqqq 💙',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'اضافة حساب 👨🏻‍💻','callback_data'=>'login']],
                       [['text'=>"𝘿𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧", 'url'=>"https://t.me/jfqqq"]],
                      ]
                  ])
              ]);   
          } 
if($text == '/help'){
              ...
              'video'=>"https://t.me/hhhh_7l/59",
              'caption'=>'طرق السحبب🤘😂',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"𝙍𝙚𝙥𝙤𝙧𝙩 𝙋𝙧𝙤𝙗𝙡𝙚𝙢𝙨", 'url'=>"https://t.me/jfqqq"]],
                       ]
                       ])
                       ]);
    
              $bot->sendvoice([ 'chat_id'=>$chatId,
                  'voice'=>"https://t.me/nnnneueh2/55",
                           'caption'=>'الصيد تضمن كيف😂🤘',
                ]);
                      $bot->sendvoice([ 'chat_id'=>$chatId,
                  'voice'=>"https://t.me/hhhh_7l/59",
